var text = new function(){
    ...
    for (i = 3; i > 0; i --){
      (function(j){
        setTimeout(function(){
          ...
          text.new(j, 100/CANVAS.stage.scaleX + "px Eco", "#feeda7");
  ...
  this.score = function(score){
    this.new("Your score: " + score, 60/CANVAS.stage.scaleX + "px Eco", "#feeda7");
  ...
  this.scoreandrecord = function(score){
    this.new("Your score: " + score + "\n" + "New record!", 60/CANVAS.stage.scaleX + "px Eco", "#feeda7");
